...
const HomeSectionOne=()=>{
    ...
    return(
        <div className=" ">
            {/* sec one */}
            <section className="pt-20 text-white flex px-[5rem] flex-col items-center bg-gradient-to-r from-sky-800 to-gray-900 lg:h-screen">
            ...
            {/* sec two */}
            <div className="pt-32 bg-neutral-200 lg:px-[1rem]">
                ...
                <div className=" md:flex lg:flex   md:gap-3 md:px-[1rem] lg:px-[5rem] pt-32 pb-24 ">
                    {/* 1 */}
