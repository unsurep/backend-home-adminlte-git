...
//         <div>
//             {/* 1 */}
//             <section className="bg-white pt-40 px-[5rem] pb-32">
//                 <h1 className="flex items-center justify-center text-blue-950 text-4xl font-extrabold">Works Great With</h1>
//                 <div className="flex items-center justify-between pt-20">
//                     <div>
//                         <Image src={l1} width={0} height={0} alt="image"/>
//                     </div>

//                     <div>
//                         <Image src={l2} width={0} height={0} alt="image"/>
//                     </div>

//                     <div>
//                         <Image src={l3} width={0} height={0} alt="image"/>
//                     </div>


//                     <div>
//                         <Image src={l4} width={0} height={0} alt="image"/>
//                     </div>


//                     <div>
//                         <Image src={l5} width={0} height={0} alt="image"/>
//                     </div>
//                 </div>


//                 <div className="bg-blue-500 mt-20 flex p-[5rem] rounded-xl   ">
